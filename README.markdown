...
````
<link rel="stylesheet" type="text/css" href="//cdn.jsdelivr.net/jquery.slick/1.5.1/slick.css"/>
...
```
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.slick/1.5.1/slick.min.js"></script>
```
