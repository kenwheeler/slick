...
(function(factory) {
  ...
  Slick.prototype.getLeft = function(slideIndex) {
    ...
    if (
      _.options.centerMode === true && _.slideCount <= _.options.slidesToShow
    ) {
    ...
    if (_.options.variableWidth === true) {
      if (
        _.slideCount <= _.options.slidesToShow || _.options.infinite === false
      ) {
  ...
  Slick.prototype.setSlideClasses = function(index) {
    ...
    if (
      _.options.lazyLoad === "ondemand" || _.options.lazyLoad === "anticipated"
    ) {
      _.lazyLoad();
    }
  };
  ...
  Slick.prototype.swipeStart = function(event) {
    ...
    if (
      _.touchObject.fingerCount !== 1 || _.slideCount <= _.options.slidesToShow
    ) {
      _.touchObject = {};
      return false;
    }
  ...
  Slick.prototype.updateArrows = function() {
    ...
    if (
      ...
      if (_.currentSlide === 0) {
        ...
        _.currentSlide >= _.slideCount - 1 && _.options.centerMode === true
      ) {
        _.$nextArrow.addClass("slick-disabled").attr("aria-disabled", "true");
        _.$prevArrow
          .removeClass("slick-disabled")
