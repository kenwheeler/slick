...
;(function(factory) {
    ...
    Slick.prototype.buildArrows = function() {
        ...
        if (_.options.accessibility && _.options.autoplay) {
            ...
            }).appendTo($slideControls).wrapAll('<li></li>');
    ...
    Slick.prototype.postSlide = function(index, forceFocus = false) {
    ...
    Slick.prototype.slideHandler = function(index, sync, dontAnimate, forceFocus = false) {
